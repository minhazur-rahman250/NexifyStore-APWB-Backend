...
import { Buyer } from './buyer.entity'; // change this to your entity class
import { Repository } from 'typeorm';


@Injectable()
export class BuyerService {
  constructor(@InjectRepository(buyer) private buyerRepository: Repository<Buyer> {} 
  ...
  // Update a buyer
  async updateBuyer(id: number, updatedBuyer: Buyer): Promise<User> {
    //Update the user with provided ID using the updatedBuyer data
   await this.buyerRepository.update(identity, updateBuyer);
